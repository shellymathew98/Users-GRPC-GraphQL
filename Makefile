...
users: $@ ## Generate Pbs and build for users
...
clean: clean_users## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_users: ## Clean generated files for users
	${RM_F_CMD} users/${PROTO_DIR}/*.pb.go
